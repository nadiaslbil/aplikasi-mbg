...
const allMenuItems: MenuItem[] = [
  ...
  { href: '/dashboard/assign-kurir', icon: UserCheck, label: 'Assign Kurir', roles: ['admin_bgn', 'admin_daerah'] },
  { href: '/dashboard/assign-sekolah', icon: School, label: 'Assign Sekolah', roles: ['admin_bgn', 'admin_daerah'] },
